    ...
    <div className={active ? "modal__content active" : "modal__content"} onClick={e => e.stopPropagation()}>
        ...
        <div className="form">
            ...
            {showDangerIcon && <div className="danger">
                <img className="svg" title="svg" src={dangerous} alt="" /></div>}
            ...
            {showDangerIcon2 && <div className="danger">
                <img className="svg-two" title="svg" src={dangerous} alt="" /></div>}
                
                 {(numberApprov && numberError) && <div className="error-two">{numberError}</div>}
            ...
            <div className="module--blockk__content--checkboxs">
                ...
                <div className={checkState ? "modal activee" : "modale"} onClick={() => {
                setCheck(false);
                setSubmitted(false)}} >
                <div className="modale--w" onClick={e => e.stopPropagation()}>
<div style={{display: submitted ? 'flex' : 'none',}} className="moduletrue">
            <div> </div>
            <img src={modalSvg} onClick={()=>{ setCheck(false)
            setSubmitted(false) }} className="module--blockk__crosser" alt="" />
