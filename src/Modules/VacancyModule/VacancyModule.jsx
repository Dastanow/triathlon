    ...
    <div className={active ? "modal__content active" : "modal__content"} onClick={e => e.stopPropagation()}>
        ...
        <div className="form">
            ...
            <h2 className="form-title">Откликнуться на вакансию </h2>
                ...
                {showDangerIcon && <div className="danger">
                <img className="user-svg"  src={dangerous} alt="" /></div>}
                
                {(userApprov && userError) && <div className="user">{userError}</div>}
                ...
                />
                 {showDangerIcon2 && <div className="danger">
                <img className="email_svg"  src={dangerous} alt="" /></div>}

                {(emailApprov && emailError) && <div className="email">{emailError}</div>}
                ...
                {showDangerIcon3 && <div className="danger">
                                <img className="number_svg"  src={dangerous} alt="" /></div>}
                
                 {(numberApprov && numberError) && <div className="number">{numberError}</div>}
                 </div>
            </div>
            ...
            <div className="file">
                ...
                <h6 className="file__drop">Перетащите файл сюда или  <span className="file__ins">загрузите файл,</span></h6>

                <div className="warning">
                    <div className="warning-titles">Размер файла не должен превышать 10 Мб </div>
                    <div className="warning-titles">Поддерживаемый формат файлов: pdf, doc, docx</div>
                </div>
            </div>
            ...
            <div className="module--blockk__content--checkboxs">
                        ...
                        <label className="box">
                            ...
                            <h4 className="checks">Я согласен с публичным <a
                            className="link" href="">договором-офертой</a> и <a 
                            className="link" href="">
                                политикой</a> 
                                 <a className="link-ed" href=""> обработки персональных данных</a></h4>
                        </label>
