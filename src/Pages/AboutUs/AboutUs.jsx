            ...
            <div className="about__us_container">
                ...
                <div className="about__us__platfor">
                    ...
                    <div className="about__us__content">
                        ...
                        <p>
                            <p>Добро пожаловать в наш фитнес-клуб! </p>Наш
                            фитнес-клуб — это место, где забота о вашем здоровье
                            и благополучии становится страстью. Мы создали
                            уютное пространство, где каждый посетитель может
                            обрести не только физическую форму, но и
