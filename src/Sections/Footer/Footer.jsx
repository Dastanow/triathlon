        ...
        <footer className="footer">
            <Container classNames="footerContainer">
                    ...
                    <div className="footerInformContent">
                        ...
                        <ul className="footerList">
                            <li className="footerContact">
                                <a href="https://www.google.com/maps/place/10+%D0%A4%D0%B0%D1%82%D1%8C%D1%8F%D0%BD%D0%BE%D0%B2%D0%B0,+Bishkek/@42.8600908,74.6056157,20.67z/data=!4m5!3m4!1s0x389eb632b000a38b:0xae646f5966b1033e!8m2!3d42.8601249!4d74.6056813?entry=ttu" target="_blank">
                                    <img src={Map} alt="map" />
                                </a>
                                <a className="footerLabel" href="https://www.google.com/maps/place/10+%D0%A4%D0%B0%D1%82%D1%8C%D1%8F%D0%BD%D0%BE%D0%B2%D0%B0,+Bishkek/@42.8600908,74.6056157,20.67z/data=!4m5!3m4!1s0x389eb632b000a38b:0xae646f5966b1033e!8m2!3d42.8601249!4d74.6056813?entry=ttu" target="_blank">Бишкек, ул.Фатьянова 10</a>
                            </li>
                            <li className="footerContact">
                                <a href="mailto:triathloncenter.kg@gmail.com" target="_blank">
                                    <img src={Email} alt="email" />
                                </a>
                                <a className="footerLabel" target="_blank" href="mailto:triathloncenter.kg@gmail.com">triathloncenter.kg@gmail.com</a>
                            </li>
                            <li className="footerContact">
                                <a href="https://www.instagram.com/triathloncenter.kg?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank">
                ...
                <div className="footerBottom">
                    <a href="" target="_blank">Made by GEEKS PRO</a>
                </div>
            </Container>
        </footer>
    )
