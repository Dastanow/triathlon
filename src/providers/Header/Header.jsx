...
const Header = () => {
    ...
    const switchLanguage = () => {
        const newLanguage = selectedLanguage === 'rus' ? 'eng' : 'rus';
            ...
            <Container classNames="headerContainer">
                ...
                <div className="headerWrapper">
                    <div className="headerLanguage" onClick={handleSvgClick}>
                        <img src={selectedLanguage === 'rus' ? rus : kyr} alt={selectedLanguage === 'rus' ? 'Russian' : 'Kyrgyz'} />
                        <img src={chevron} alt="Chevron" />
                        {showOtherImage && (
                            <div className="header-back">
                                <div className="headerOption" onClick={switchLanguage}>
                                    <img src={selectedLanguage === 'rus' ? kyr : rus} alt={selectedLanguage === 'rus' ? 'Kyrgyz' : 'Russian'} />
                                </div>
                            </div>
                        )}
                    </div>
